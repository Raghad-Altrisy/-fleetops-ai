...
with tab_upload:
    ...
    st.markdown(
        ...
        "analysis pipeline** shown above against real or different data. Nothing is uploaded to any "
        "external server — files are processed only in this app's memory for your session."
    )

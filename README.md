...
- Downtime chart uses a continuous low-to-high warning gradient driven by the actual `downtime_rate_%`.
- Utilization-by-project chart uses a continuous performance gradient.
- Sidebar includes configurable AI mode, chart item count, color scale, value labels, data reset, and refresh controls.
- Fleet reports can be exported as **CSV, JSON, or PDF** from the Report tab.
- Footer includes competition, track, team, and product capability information.
